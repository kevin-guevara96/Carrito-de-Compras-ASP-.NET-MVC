...
namespace CapaPresentacionTienda.Controllers
{
    public class TiendaController : Controller
    {
        ...
        public ActionResult DetalleProdutcto(int idproducto = 0)
        {
        ...
        public async Task<JsonResult> ProcesarPago(List<Carrito> oListaCarrito, Venta oVenta)
        {
            ...
            return Json(new { Status = true, Link = "/Tienda/PagoEfectuado?idTransaccion="+ random.Next() +"&status=true" },JsonRequestBehavior.AllowGet);
        }
